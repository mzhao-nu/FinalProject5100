 ...
 * @author gyt
 */
public class ModifyTesterJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ModifyTesterJPanel
     */
    ...
    public ModifyTesterJPanel(JPanel userProcessContainer,UserAccount account, EcoSystem ecoSystem,DnaTester dnaTester) {
        initComponents();
        ...
        txtAge.setText(String.valueOf(dnaTester.getAge()));
        txtName.setText(dnaTester.getName());
        txtPassword.setText(dnaTester.getUa().getPassword());
        txtPhoneNum.setText(dnaTester.getPhoneNum());
        txtUsername.setText(dnaTester.getUa().getUsername());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Modify DNA Tester");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        // Data validation
        if (name.isEmpty())    errorMsg += "Tester name is required.\n";
